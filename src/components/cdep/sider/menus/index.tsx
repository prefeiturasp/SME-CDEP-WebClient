...
import { MENU_ATENDIMENTO_SOLICITACOES } from './lista-menus/atendimento-solicitacoes';
...
export const menus: MenuItemCDEPProps[] = [MENU_MEUS_DADOS, MENU_CADASTRO, MENU_ATENDIMENTO_SOLICITACOES];
