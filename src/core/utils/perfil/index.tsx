...
import { RolesMenu, menus } from '~/components/cdep/sider/menus';
...
export const menuTemPermissao = (permissao: PermissaoMenusAcoesDTO) =>
  !!(
    permissao.podeAlterar ||
    permissao.podeConsultar ||
    permissao.podeExcluir ||
          ...
          switch (subMenu.key) {
            ...
            default:
              if (subMenu.roles) {
                ...
                const menuTemPermissao = !!permissao?.podeConsultar;
