export enum ROUTES {
  ...
  ATENDIMENTO_SOLICITACOES = '/acervo/atendimento-solicitacoes',
  ATENDIMENTO_SOLICITACOES_EDITAR = '/acervo/atendimento-solicitacoes/:id',
  ATENDIMENTO_SOLICITACAO_MANUAL = '/acervo/atendimento-solicitacoes/solicitacao-manual',
  ATENDIMENTO_SOLICITACAO_MANUAL_EDITAR = '/acervo/atendimento-solicitacoes/solicitacao-manual/:id',
  GESTAO = '/gestao',
  ...
  HISTORICO_SOLICITACOES = '/relatorios/historico-solicitacoes',
