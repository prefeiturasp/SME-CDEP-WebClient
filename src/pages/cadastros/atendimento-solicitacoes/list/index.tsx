        ...
        <Form form={form} layout='vertical' autoComplete='off'>
          <Form.Item shouldUpdate>
            {() => (
              <Row gutter={[16, 8]}>
                <Col xs={24} sm={8}>
                  <Form.Item label='N° da solicitação' name='N° da solicitação'>
                    <Input type='text' placeholder='N° da solicitação' id={CDEP_INPUT_TITULO} />
                  </Form.Item>
                </Col>
                <Col xs={24} sm={8}>
                  <SelectTipoAcervo />
                ...
                <Col xs={24} sm={8}>
                  <Form.Item label='Data da Solicitação' name='titulo'>
                    <Input type='text' placeholder='Data da Solicitação' id={CDEP_INPUT_TITULO} />
                  </Form.Item>
                </Col>              
                <Col xs={24} sm={8}>
                  <Form.Item label='Data da Solicitação' name='titulo'>
