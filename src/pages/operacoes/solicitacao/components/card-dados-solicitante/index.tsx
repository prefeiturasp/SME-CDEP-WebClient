...
const CardDadosSolicitante: React.FC = () => {
  ...
  return <>
    <Card type="inner" style={{ borderColor: Colors.Neutral.LIGHT, borderRadius: 4 }} title={<Title style={{ color: Colors.SystemSME.CDEP.PRIMARY_DARK, fontSize: 14, fontWeight: 700, marginBottom: 0}}>Dados do solicitante</Title>}  loading={loading}>
        <Row align="middle" wrap={false} justify="space-between">
          <Col xs={12}>
            <Row justify="space-between" wrap={false}>
              ...
              <Divider type="vertical" style={{ borderColor: Colors.BACKGROUND_CONTENT, height: 100 }} />
            </Row>
          </Col>
          <Col xs={12}>
            <Row>
