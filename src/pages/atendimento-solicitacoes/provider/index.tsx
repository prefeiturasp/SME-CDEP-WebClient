...
type AtendimentoSolicitacoesContextProps = {
...
const DEFAULT_VALUES: AtendimentoSolicitacoesContextProps = {
  dataSource: [],
  loading: false,
  listParams: {
    current: 1,
...
export const AtendimentoSolicitacoesContext = createContext<AtendimentoSolicitacoesContextProps>(DEFAULT_VALUES);

const AtendimentoSolicitacoesContextProvider: React.FC<PropsWithChildren> = ({ children }) => {
  ...
  return (
    <AtendimentoSolicitacoesContext.Provider
      value={{
        dataSource,
        setDataSource,
        loading,
...
export default AtendimentoSolicitacoesContextProvider;
