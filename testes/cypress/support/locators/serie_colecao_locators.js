class Serie_Colecao_Localizadores {

  // criar
  menu_serie_colecao = () => 'span.ant-menu-title-content:contains("Série/Coleção")'
...
export default Serie_Colecao_Localizadores 