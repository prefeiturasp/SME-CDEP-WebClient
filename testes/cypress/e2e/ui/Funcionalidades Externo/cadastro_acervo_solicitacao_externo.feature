...
Funcionalidade: Solicitação de acervos
  ...
  Esquema do Cenário: Validar busca de consulta de acervo por tipo: <caso>  
    E clico no botão "Nova Solicitação" da tela "Minhas solicitações"
